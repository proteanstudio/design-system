...
const ProteanOptgroup = class {
  ...
  render() {
    return (index.h("div", { class: "protean-optgroup-container", role: "group", "aria-labelledby": this.labelId, "aria-disabled": this.disabled ? "true" : null }, this.label && (index.h("div", { class: "protean-optgroup-label", id: this.labelId, role: "presentation" }, index.h("div", { class: "protean-optgroup-label-text" }, index.h("span", null, this.label)))), index.h("div", { class: "protean-optgroup-option-container", role: "presentation" }, index.h("slot", null))));
  }
  get hostElement() { return index.getElement(this); }
  static get watchers() { return {
