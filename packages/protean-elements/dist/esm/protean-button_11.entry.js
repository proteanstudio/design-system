import { r as registerInstance, h, g as getElement, c as createEvent } from './index-186659a2.js';
...
const ProteanButton = class {
  ...
  render() {
    return (h("button", { type: this.type ?? 'button', disabled: this.disabled, "aria-label": this.a11yLabel }, h("div", null, h("slot", null))));
  }
...
const ProteanSelect = class {
  ...
  render() {
    return (h("protean-click-elsewhere", { onChange: this.onClickElsewhere, class: "select-container" }, h("protean-input", { value: this.displayValue, label: this.label, optional: this.optional, errors: this.errors, disabled: this.disabled, "suppress-messages": true, type: "button", a11yLabel: this.selectAriaLabel, ariaHasPopup: "listbox", ariaExpanded: this.dropdownOpen, onClick: this.onInputClick, onKeyDown: this.onInputKeyDown }), h("protean-icon", { class: "protean-select-icon", type: "chevron-down" }), h("div", { class: "protean-select-separator", hidden: !this.dropdownOpen }), this.renderDropdown()));
  }
  renderDropdown() {
